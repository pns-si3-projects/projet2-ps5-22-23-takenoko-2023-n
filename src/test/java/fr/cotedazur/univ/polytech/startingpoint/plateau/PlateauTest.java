...
class PlateauTest {
    ...
    void setUp(){
        ...
        try {
            ...
            bambou2_0 = new Bambou(pC20,couleurBambouDefault);
            bambou2_0.ajouteSectionBambou(secBam2_0);
            plateau.addParcelle(pC11, secBam1_1);
            bambou1_1 = new Bambou(pC11,couleurBambouDefault);
    ...
    void getPositionsDisponible() {
        ...
        try {
            plateau.addParcelle(new ParcelleCouleur(new Position(3,1)), new SectionBambou(couleurBambouDefault));
        }
    ...
    void addParcelleSansException() {
        ...
        Bambou bambou3_1 = new Bambou(pC31,couleurBambouDefault);
        Bambou bamboum1_m1 = new Bambou(pCm1m1,couleurBambouDefault);
        try {
            plateau.addParcelle(pC31, secBam3_1);
            listParcelle.add(pC31);
