...
class MotifVTest {
    ...
    @Test
    void getOrientation() {
        ParcelleCouleur[][] allOrientation = motifV.getOrientation();
    ...
    void getOrientationForIA() {
        ParcelleCouleur[][] allOrientation = motifV.getOrientationForIA();
        ParcelleCouleur[] orientation =  new ParcelleCouleur[3];
    ...
    @Test
    void getTableau(){
        ParcelleCouleur[] tableauParcelleCouleurMotif = motifV.getTableauParcelles();
    ...
    void compareMotif() {
        ...
        Motif motifRessemblant556484 = new MotifV(parcelleCouleur55, parcelleCouleur64, parcelleCouleur84);
        assertTrue(motifV.compareMotif(motifRessemblant556484));

        ParcelleCouleur parcelleCouleur73 = new ParcelleCouleur(new Position(7, 3), couleurDefaut);
        Motif motifDiagonale = new MotifV(parcelleCouleur55, parcelleCouleur64, parcelleCouleur73);
        assertFalse(motifV.compareMotif(motifDiagonale));
    }
    ...
    void equalsSansOrientation() {
        ...
        ParcelleCouleur parcelleCouleur3m1 = new ParcelleCouleur(new Position(3, -1), couleurDefaut);
        MotifV motifDecaleDifferentePosition = new MotifV(parcelleCouleur3m3, parcelleCouleur4m2, parcelleCouleur3m1);
        assertEquals(motifV, motifDecaleDifferentePosition);
    }
    ...
    void equalsAvecOrientation() {
        ...
        for (ParcelleCouleur[] orientation : allOrientation) {
            Motif motifRessemblantDecale = new MotifV(orientation[0], orientation[1], orientation[2]);
            assertEquals(motifV, motifRessemblantDecale);
        }
    }
}