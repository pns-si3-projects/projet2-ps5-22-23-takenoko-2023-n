...
class GestionnairePossibilitePlateauTest {
    ...
    void positionPossiblePourPrendreMotif2Parcelles(){
        ...
        ParcelleCouleur parcelleCouleur11 = new ParcelleCouleur(pC11J.position(),secBamV.couleur());
        Position position20 = new Position(2,0);
        try {
            plateauPourMotif.addParcelle(parcelleCouleur11, secBamV);
        }
        catch (ParcelleExistanteException | NombreParcelleVoisineException exception) {
            throw new AssertionError("Ne doit normalement pas renvoyer d'erreur");
        }
        optPosition = gPPMotif.positionPossiblePrendrePourMotif(objectifParcelleSimple2Parcelle);
        assertTrue(optPosition.isPresent());
        assertEquals(position20,optPosition.get());

        ParcelleCouleur parcelleCouleur20 = new ParcelleCouleur(position20,secBamV.couleur());
        Position position31 = new Position(3,1);
        try {
            plateauPourMotif.addParcelle(parcelleCouleur20, secBamV);
        }
        catch (ParcelleExistanteException | NombreParcelleVoisineException exception) {
            throw new AssertionError("Ne doit normalement pas renvoyer d'erreur");
        }
        ...
        ParcelleCouleur parcelleCouleur31 = new ParcelleCouleur(position31,secBamV.couleur());
        try {
            plateauPourMotif.addParcelle(parcelleCouleur31, secBamV);
        }
        catch (ParcelleExistanteException | NombreParcelleVoisineException exception) {
            throw new AssertionError("Ne doit normalement pas renvoyer d'erreur");
        }
        optPosition = gPPMotif.positionPossiblePrendrePourMotif(objectifParcelleSimple2Parcelle);
        assertTrue(optPosition.isEmpty()); // Car l'objectif est déjà fait
    }
    ...
    void positionPossiblePourPrendreMotif3Parcelles(){
        ...
        ParcelleCouleur parcelleCouleur11 = new ParcelleCouleur(pC11J.position(),secBamV.couleur());
        ParcelleCouleur parcelleCouleur20 = new ParcelleCouleur(new Position(2,0),secBamV.couleur());
        ParcelleCouleur parcelleCouleur31 = new ParcelleCouleur(new Position(3,1),secBamV.couleur());
        ...
        ParcelleCouleur parcelleCouleur22 = new ParcelleCouleur(position22,secBamV.couleur());
        Position position42 = new Position(4,2);
        try {
            plateauPourMotif.addParcelle(parcelleCouleur22, secBamV);
        }
        catch (ParcelleExistanteException | NombreParcelleVoisineException exception) {
            throw new AssertionError("Ne doit normalement pas renvoyer d'erreur");
        }
        ...
        ParcelleCouleur parcelleCouleur42 = new ParcelleCouleur(position42,secBamV.couleur());
        try {
            plateauPourMotif.addParcelle(parcelleCouleur42, secBamV);
        }
        catch (ParcelleExistanteException | NombreParcelleVoisineException exception) {
            throw new AssertionError("Ne doit normalement pas renvoyer d'erreur");
        }
