...
class PiocheObjectifJardinierTest {
    ...
    void pioche() {
        ...
        piocheObjectifJardinier = new PiocheObjectifJardinier(mockRandom);
        Assertions.assertEquals(new ObjectifJardinier(3, 4, "VERT",1), piocheObjectifJardinier.pioche());
        assertEquals(new ObjectifJardinier(5, 4, "VERT",1), piocheObjectifJardinier.pioche());
        // car en supprimant 10, les suivant sont décalés donc on prend ancien 12
        assertEquals(new ObjectifJardinier(6, 4, "VERT",1), piocheObjectifJardinier.pioche());
        assertEquals(new ObjectifJardinier(5, 4, "VERT",1), piocheObjectifJardinier.pioche());
        // car en supprimant 0, les suivant sont décalés donc on prend ancien 2
        assertEquals(new ObjectifJardinier(6, 6, "VERT",1), piocheObjectifJardinier.pioche());
    }
}