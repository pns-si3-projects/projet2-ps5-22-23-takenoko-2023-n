...
class MotifDiagonaleTest {
    ...
    void setUp(){
        ...
        motifACree2ParcelleBis = new MotifDiagonale(parcelleCouleurm8m6,parcelleCouleurm9m7);
        motifACree3ParcelleBis = new MotifDiagonale(parcelleCouleurm8m6,parcelleCouleurm9m7,parcelleCouleurm10m8);
    ...
    void getTableauParcelles() {
        ...
        assertEquals(parcelleCouleurm8m6, tableauParcelleMotif[0]);
        assertEquals(parcelleCouleurm9m7, tableauParcelleMotif[1]);
        assertEquals(parcelleCouleurm10m8, tableauParcelleMotif[2]);
    }
