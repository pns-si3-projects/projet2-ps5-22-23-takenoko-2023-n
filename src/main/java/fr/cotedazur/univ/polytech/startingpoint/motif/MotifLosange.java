...
public class MotifLosange extends Motif{
     ...
     */
    public MotifLosange(ParcelleCouleur parcelleCouleur00, ParcelleCouleur parcelleCouleur11,
                        ParcelleCouleur parcelleCouleurm11, ParcelleCouleur parcelleCouleur02) {
        if (parcelleCouleur00 == null || parcelleCouleur11 == null
                || parcelleCouleurm11 == null || parcelleCouleur02 == null) {
    ...
    public ParcelleCouleur[][] getOrientation() {
        ...
        for (int i = 1; i < 6; i++) {
            ...
            allOrientation[i][3] =
                    getVoisin(i - 1, allOrientation[i][1].getPosition(), tabParcelles[3].getCouleur());
        }
